    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          margin: const EdgeInsets.only(left: 19, right: 16, top: 10, bottom: 12),
        ...
        Padding(
            ...
            child: Container(
              decoration: BoxDecoration(color: const Color(0xfffe2d54), borderRadius: BorderRadius.circular(4)),
              width: double.infinity,
              height: 36,
